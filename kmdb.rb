...
#Run the code to clear the tables out each time
Movie.destroy_all
Studio.destroy_all
Actor.destroy_all
Role.destroy_all

#Now let's add some data to the tables, starting with studio
new_studio = Studio.new
new_studio["name"] = "Warner Bros."
new_studio.save

#Create Studio_id link
